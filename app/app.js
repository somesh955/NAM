(function(){
	...
	angular.module('myApp', ['ngResource','pascalprecht.translate','ngSanitize','ui.router','myApp.routes','myApp.loggerService',
		...
		'myApp.biddingCtrl','myApp.biddingService','myApp.allCommodityBidListCtrl',
		'angularSpinner','myApp.SpinnerService','ui.bootstrap',
		'myApp.bidhistoryCtrl','myApp.bidhistoryService',
		'myApp.bankDetailsCtrl','myApp.bankDetailsService',
		'myApp.reportsCtrl','myApp.reportsService'
		])
	...
	.factory('httpInjector', ['CommonRequestServ','AppConstant','UtilsServ', 'StorageService' ,'$rootScope',function(CommonRequestServ, AppConstant, UtilsServ, StorageService,$rootScope) {  
